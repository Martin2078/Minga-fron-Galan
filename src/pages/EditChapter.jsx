...
const EditChapter = () => {
    ...
    const editManga = async (e) => {
        try {
            ...
            const response = await axios.put(`http://localhost:4000/chapters/${id}?manga_id=64f16659401f669668888fe1`, updatedChapter, {
                headers: {
                    Authorization: "Bearer " + token,
                },
            });
...
const EditChapter = () => {
    ...
    const editManga = async (e) => {
        try {
            ...
            const response = await axios.put(`http://localhost:4000/chapters/${id}?manga_id=64f16659401f669668888fe1`, data, {
                headers: {
                    Authorization: "Bearer " + token,
                },
            });
