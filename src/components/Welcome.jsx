...
const Welcome = () => {
  return (
    <div className="w-full bg-cover align-middle flex justify-center items-center lg:bg-url('/background.png') lg:h-4/6 lg:bg-center min-[320px]:bg-url('/imagen-mobile.png') min-[320px]:h-screen">
