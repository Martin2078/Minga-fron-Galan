...
const CommentAuthor = ({setThisComment,thisComment,comentario,commentOpen,setCommentOpen,setEdit,setDeleteC}) => {
    return (<>
        ...
        <div className='h-fit px-1 py-1 pb-5 cursor-pointer' onClick={() => { if (!commentOpen) { setCommentOpen(!commentOpen) }; setThisComment({ ...thisComment, createdAt: comentario.createdAt, text: comentario.text, user_id: comentario.user_id._id }); }}>
