...
const RegisterForm =(props) =>{
   ...
   const password=useRef()
    ...
    {isMobile ?(<fieldset className="border-solid border-2 border-black rounded-xl">
        <legend className="text-xs">Photo</legend>
        <input className="w-full h-5 rounded-xl" type="url" placeholder="Insert URL" onChange={handleChange()} />
